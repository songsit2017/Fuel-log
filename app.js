...
async function initFirebase(){
  ...
  firebaseReadyPromise = (async()=>{
    ...
    const [{firebaseConfig}, appMod, authMod, fireMod, storageMod] = await Promise.all([
      import('./firebase-config.js?v=5.0.2'),
